...
class _$IssueImpl implements _Issue {
  ...
  @override
  String toString() {
    return 'Issue(id: $id, title: $title, description: $description, userId: $userId, status: $status, createdAt: $createdAt, imageUrl: $imageUrl, attachments: $attachments, adminNotes: $adminNotes, updatedAt: $updatedAt, resolvedAt: $resolvedAt)';
  }
